...
<main>
    ...
    <div className="mt-8">
      <Image src="/portada.jpg" alt="Copa América" className="w-full rounded-lg shadow-md" height={800}
      width={400}/>
    </div>
    <div className="mt-4 flex space-x-4 justify-center">
      ...
      <div className="bg-blue/50 rounded-lg shadow-md p-6">
        ...
        <h3 className="text-xl font-bold text-black mb-2">ARGENTINA CAMPEÓN!!!</h3>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden w-full relative" style={{ height: '400px' }}>
        <Image src="/campeon.jpg" alt="Imagen Copa América" 
          layout="fill"
          objectFit="cover"
          />
      </div>
